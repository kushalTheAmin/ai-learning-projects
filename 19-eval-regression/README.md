...
half a minute: the sweeps run 50 comparisons per scenario and the power
...
date  n=40  0.9000 -> 0.6500  delta -0.2500  ci [-0.4250, -0.0750]
gate ci     pass, gate slice FAIL (date)
```
...
| scenario (truth) | naive-0.01 | naive-0.02 | ci | slice |
|---|---|---|---|---|
| noise only (no change) | 40.0% | 28.0% | 2.0% | 16.0% |
| masked slice regression | 40.0% | 32.0% | 4.0% | 68.0% |
| 3-point uniform drift | 72.0% | 58.0% | 6.0% | 24.0% |
| true 4-point improvement | 2.0% | 2.0% | 0.0% | 6.0% |
...
- the slice gate runs six uncorrected tests. bonferroni or
  benjamini-hochberg would trade its 16.0% false alarm rate against some of
  its 68.0% detection; that trade is one line of code away and unmeasured.
...
- what does multiple-comparison correction cost the slice gate in masked
  detection, measured on this exact setup?
