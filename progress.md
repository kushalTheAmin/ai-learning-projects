...
- 13: int8 quantization of the vectors before the distance kernel is the standard memory play; its recall cost per ef on this exact sweep is the [py] embedding-quantization topic's natural home now
