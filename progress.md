...
- 02: the whole-list bound of a common term is set by its single best posting — block-max wand keeps a max per posting block so the pivot can skip within a list, and how much deeper than the measured 30% common-heavy floor it cuts at top-10 is the next pruning question
