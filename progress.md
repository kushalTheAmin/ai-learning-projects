...
- 22: the streaming queue caps events, not bytes — 05's queue now takes a maxBytes budget (2026-09-01), so switching the /ask event queue to it and re-reading the slow-client table is a composition waiting to be run
